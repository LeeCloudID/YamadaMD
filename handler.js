                ...
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        ...
                        try {
                            ...
                            text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || '𝖶 𝖤 𝖫 𝖢 𝖮 𝖬 𝖤 @user!').replace('@subject', await this.getName(id)).replace('@desc', groupMetadata.desc ? String.fromCharCode(8206).repeat(4001) + groupMetadata.desc : '') :
                                (chat.sBye || this.bye || conn.bye || '𝖦 𝖮 𝖮 𝖣 𝖡 𝖸 𝖤 @user!')).replace('@user', await this.getName(user))
...
global.dfail = (type, m, conn) => {
    ...
    let imgr = 'https://telegra.ph/file/a99c79e1727fbca332cdf.jpg'
    let nmsr = `👋 Hai ${tag}!`
    let msg = {
    ...
    let daftar = 'https://telegra.ph/file/a99c79e1727fbca332cdf.jpg'
    let msgg = {
        unreg: `${nmsr}\n\nAnda belum terdaftar!\n\nKetik: *#daftar nama.umur*\n\nContoh: *#daftar Manusia.16*`
    }[type]
    if (msgg) return m.reply(msgg)
        let preimg = 'https://telegra.ph/file/a99c79e1727fbca332cdf.jpg'
    let msg2 = {
